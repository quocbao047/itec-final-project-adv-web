...
<div class="middle" style=" position:fixed; padding:40px; border:3px solid #ED2553; left:35%; top:20%; width:400px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#FFFFFF;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
