...
<div class="middle" style=" position:fixed; padding:30px; border:1px solid #ED2553; left:35%; top:15%; width:400px;">
            ...
            <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
			    <form method="post" enctype="multipart/form-data">
				   ...
				   <div class="form-group">
                      ...
                      <input type="tel" id="mobile" class="form-control" name="mobile" pattern="" placeholder="Phone(optinal) EX 9213298761" required>
                    </div>
