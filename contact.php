...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>Contact No: (+84)-28-38303625</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; I Building, ITEC Campus, HCMC, VIETNAM Zip Code-70000<br>(24*7 Days)
