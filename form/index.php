...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="../index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">ITEC FOODSTORE</span></a>
			...
			<div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
			    <form method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" id="name"  class="form-control" name="name" placeholder="Enter your first name..." required="required"/>
                    </div>

					<div class="form-group">
						<label for="name">Last Name</label>
						<input type="text" id="name"  class="form-control" name="name" placeholder="Enter your last name..." required="required"/>
					</div>
				   ...
				   <div class="form-group">
                      ...
                      <input type="tel" id="mobile" class="form-control" name="mobile"  data-testid="phoneNumber" id="phoneNumber" name="phoneNumber" placeholder="Phone(optinal) EX 9213298761" type="text" value="">
                    </div>
